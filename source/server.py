...
def get_master(timeout=10):
    global master
    if master is None or not master.port:  
        master = mavutil.mavlink_connection('udp:127.0.0.1:14540')
        try:
            hb = master.wait_heartbeat(timeout=timeout)
            if not hb:
                raise Exception(" Not receive HEARTBEAT")
...
def upload_mission():
    ...
    try:
        ...
        time.sleep(0.2)    # doi cac api dung han
...
def vehicle_position():
    try:
        ...
        with mavlink_lock:
            ...
            shared_data["timestamp"]= msg.time_usec 
    ...
    try:
        ...
        with mavlink_lock:
            ...
            if msg:
                ...
                shared_data["mission_curr"] = msg.seq
